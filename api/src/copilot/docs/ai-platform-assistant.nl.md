...
title: Wat is de AI-platformassistent
locale: nl
tags:
  - copilot
  - platform-assistant
...
**Iemand van vlees en bloed nodig?** Onderaan het paneel staat **Praat met een mens**. Daarmee stuur je je vraag naar onze support, samen met dit gesprek, zodat je het niet twee keer moet uitleggen.

**Abonnement:** alleen Pro en Enterprise. Op Essential zie je een Pro-slot op de knop.

**Daglimiet:** er geldt een maximum aantal berichten per dag om ongecontroleerd verbruik te vermijden. Bereik je die limiet, dan zegt de assistent wanneer ze weer wordt vrijgegeven.
