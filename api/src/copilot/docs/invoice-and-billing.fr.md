...
title: Retrouver vos factures et vos données de facturation
locale: fr
tags:
  - billing
  - invoices
...
Tout ce qui concerne la facturation se trouve sous *Paramètres → Facturation*.
...
**Changer l'e-mail de facturation :** *Paramètres → Facturation → E-mail de facturation*. Cette adresse est distincte de votre identifiant — les reçus et factures partent vers l'e-mail de facturation.

**Numéro de TVA :** indiquez-le sous *Paramètres → Facturation → Données fiscales*. Il figurera sur vos prochaines factures.

**Devise :** les factures sont en euros pour les clients européens et en dollars pour les autres. La devise est fixée à l'inscription et ne change plus ensuite.
