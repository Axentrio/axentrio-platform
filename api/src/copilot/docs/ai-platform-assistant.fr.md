...
title: Qu'est-ce que l'assistant IA de la plateforme
locale: fr
tags:
  - copilot
  - platform-assistant
...
**Besoin de quelqu'un en chair et en os ?** En bas du panneau se trouve **Parler à quelqu'un**. Votre demande part vers notre support avec cette conversation jointe, pour ne pas devoir tout réexpliquer.

**Formule :** Pro et Enterprise uniquement. Sur Essential, un cadenas Pro s'affiche sur le bouton.

**Limite quotidienne :** un plafond de messages par jour évite les usages incontrôlés. Si vous l'atteignez, l'assistant vous indique quand il se réinitialise.
