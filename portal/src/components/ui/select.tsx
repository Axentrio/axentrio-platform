...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-lg border border-edge bg-surface-1 px-3 py-2",
      "text-sm text-text-primary",
      "transition-colors duration-150",
      "placeholder:text-text-muted",
      "hover:border-edge-light",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-lg border border-edge bg-surface-1 text-text-primary shadow-lg",
