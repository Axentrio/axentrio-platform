...
title: Facturen en facturatiegegevens terugvinden
locale: nl
tags:
  - billing
  - invoices
...
# Facturatie en facturen

Alles rond facturatie staat onder *Instellingen → Facturatie*.
...
**Facturatie-e-mail wijzigen:** *Instellingen → Facturatie → Facturatie-e-mail*. Dat adres staat los van je login — betalingsbewijzen en facturen gaan naar de facturatie-e-mail.

**Btw-nummer:** vul je btw-nummer in onder *Instellingen → Facturatie → Fiscale gegevens*. Het komt dan op je volgende facturen te staan.

**Munteenheid:** facturen staan in euro voor Europese klanten en in dollar voor de rest. De munteenheid wordt bij registratie vastgelegd en verandert daarna niet meer.
