...
export const BILLING_ERROR_CODES = {
  ...
  TOKEN_PACK_INVALID: 'token_pack_invalid',
  TOKEN_PACK_UNAVAILABLE: 'token_pack_unavailable',
...
export const BILLING_ERROR_STATUS: Record<BillingErrorCode, number> = {
  ...
  [BILLING_ERROR_CODES.TOKEN_PACK_INVALID]: 400,
  [BILLING_ERROR_CODES.TOKEN_PACK_UNAVAILABLE]: 400,
