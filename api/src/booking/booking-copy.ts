...
export const BOOKING_COPY_EN = {
  ...
  'customer.appointment_heading': 'Appointment',
  'customer.detail_appointment': 'Appointment: {summary}',
  'customer.detail_date': 'Date: {when}',
  'customer.detail_duration': 'Duration: {n} min',
  'customer.detail_price': 'Price: {price}',
  'customer.attachments_heading': 'Attachments',
  'customer.attachments_note': 'The following files are attached to this email: {names}',
  'customer.regards': 'Kind regards,',
  ...
  'manage.err_REQUEST_OUTSIDE_WINDOW': 'The business does not take appointments at that time. Please pick another.',
