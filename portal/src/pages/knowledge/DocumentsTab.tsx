...
const allFilters = [
  ...
  {
    key: "indexed",
    labelKey: "ai.knowledge.list.filters.indexed",
    group: "status",
  },
  {
    key: "processing",
    labelKey: "ai.knowledge.list.filters.processing",
    group: "status",
  },
  {
    key: "failed",
    labelKey: "ai.knowledge.list.filters.failed",
    group: "status",
  },
  ...
  { key: "url", labelKey: "ai.knowledge.list.filters.url", group: "type" },
] as const;
    ...
    <div className="space-y-4">
              ...
              <React.Fragment key={f.key}>
                {isFirstType &&
                  documents.some((d: any) =>
                    ["pdf", "docx", "text", "faq", "url"].includes(d.type),
          ...
          {documents.length === 0 ? (
            <>
              ...
              <h3 className="text-base font-medium text-text-primary">
                {t("ai.knowledge.list.empty.title")}
              </h3>
            ...
            <>
              ...
              <h3 className="text-base font-medium text-text-primary">
                {t("ai.knowledge.list.noMatches.title")}
              </h3>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t("ai.knowledge.list.deleteConfirm.title")}
            </AlertDialogTitle>
            <AlertDialogDescription>
