...
export const PLANS: Record<InternalPlanId, PlanDefinition> = {
  ...
  pro: {
    ...
    features: {
      ...
      // A tier default since the rollout gates closed — see feature-taxonomy.
      travelTime: true,
      leadCapture: true,
      ...
      channelTiktok: true,
      channelX: true,
      // Insights ladder (ADR-0013): Pro = Gaps + evidence drill-down.
      gapInsights: true,
      gapEvidence: true,
      aiBusinessInsights: false,
    },
  ...
  enterprise: {
    ...
    features: {
      ...
      channelTiktok: true,
      channelX: true,
      // Insights ladder (ADR-0013): Enterprise = full intelligence layer.
      gapInsights: true,
      gapEvidence: true,
