...
export const BUSINESS_PRESETS: BusinessPreset[] = [
  {
    ...
    services: [
      { name: "Men's haircut", durationMin: 30, bookingMode: 'auto', locationType: 'business_location', priceDisplayType: 'fixed', fixedPrice: 25 },
      { name: 'Beard trim', durationMin: 15, bookingMode: 'auto', locationType: 'business_location', priceDisplayType: 'fixed', fixedPrice: 15 },
      { name: 'Haircut + beard', durationMin: 45, bookingMode: 'auto', locationType: 'business_location', priceDisplayType: 'fixed', fixedPrice: 35 },
    ],
  ...
  },
  {
    ...
    services: [
      { name: 'Standard home clean', durationMin: 120, bookingMode: 'request', locationType: 'customer_location', customerAddressRequired: true, priceDisplayType: 'from', fixedPrice: 80 },
      { name: 'Deep clean', durationMin: 240, bookingMode: 'request', locationType: 'customer_location', customerAddressRequired: true, priceDisplayType: 'from', fixedPrice: 150 },
      { name: 'Move-out clean', durationMin: 180, bookingMode: 'request', locationType: 'customer_location', customerAddressRequired: true, priceDisplayType: 'from', fixedPrice: 110 },
    ],
    availability: DEFAULT_AVAILABILITY,
  },
  {
  ...
  },
  {
    ...
    services: [
      { name: 'Portrait session', durationMin: 60, bookingMode: 'request', locationType: 'business_location', priceDisplayType: 'on_request' },
      { name: 'Event coverage', durationMin: 120, bookingMode: 'request', locationType: 'business_location', priceDisplayType: 'on_request' },
  ...
  },
  {
    ...
    services: [
      { name: 'Unblocking', durationMin: 60, bookingMode: 'request', locationType: 'customer_location', customerAddressRequired: true, priceDisplayType: 'from', fixedPrice: 90 },
      { name: 'Leak repair', durationMin: 60, bookingMode: 'request', locationType: 'customer_location', customerAddressRequired: true, priceDisplayType: 'from', fixedPrice: 120 },
      { name: 'Boiler service', durationMin: 90, bookingMode: 'request', locationType: 'customer_location', customerAddressRequired: true, priceDisplayType: 'from', fixedPrice: 150 },
    ],
    availability: DEFAULT_AVAILABILITY,
  },
  {
    ...
    services: [
      { name: 'Socket or switch', durationMin: 60, bookingMode: 'request', locationType: 'customer_location', customerAddressRequired: true, priceDisplayType: 'from', fixedPrice: 80 },
      { name: 'Fuse board', durationMin: 120, bookingMode: 'request', locationType: 'customer_location', customerAddressRequired: true, priceDisplayType: 'on_request' },
      { name: 'Electrical inspection', durationMin: 60, bookingMode: 'request', locationType: 'customer_location', customerAddressRequired: true, priceDisplayType: 'from', fixedPrice: 120 },
    ],
    availability: DEFAULT_AVAILABILITY,
  },
  {
    ...
    services: [
      { name: 'Facial', durationMin: 60, bookingMode: 'auto', locationType: 'business_location', priceDisplayType: 'fixed', fixedPrice: 55 },
      { name: 'Manicure', durationMin: 45, bookingMode: 'auto', locationType: 'business_location', priceDisplayType: 'fixed', fixedPrice: 35 },
      { name: 'Waxing', durationMin: 30, bookingMode: 'auto', locationType: 'business_location', priceDisplayType: 'fixed', fixedPrice: 25 },
    ],
    availability: DEFAULT_AVAILABILITY,
  },
  {
    ...
    services: [
      { name: 'Oil change', durationMin: 45, bookingMode: 'request', locationType: 'business_location', priceDisplayType: 'from', fixedPrice: 80 },
      { name: 'Diagnostics', durationMin: 60, bookingMode: 'request', locationType: 'business_location', priceDisplayType: 'from', fixedPrice: 60 },
      { name: 'Inspection', durationMin: 45, bookingMode: 'request', locationType: 'business_location', priceDisplayType: 'from', fixedPrice: 50 },
    ],
    availability: DEFAULT_AVAILABILITY,
  },
  {
    ...
    services: [
      { name: 'Consultation', durationMin: 20, bookingMode: 'auto', locationType: 'business_location', priceDisplayType: 'none' },
      { name: 'Small tattoo', durationMin: 60, bookingMode: 'request', locationType: 'business_location', priceDisplayType: 'on_request' },
      { name: 'Touch-up', durationMin: 45, bookingMode: 'request', locationType: 'business_location', priceDisplayType: 'on_request' },
    ],
    availability: DEFAULT_AVAILABILITY,
  },
];
