...
export function renderSystemPrompt(args: BuildPromptArgs): string {
  ...
  return (
    ...
    '- Call `getBusinessHours` for any question about opening hours, business hours, or when the business is open. Incomplete setup does not mean hours are missing. To change hours, link [AI & Content](/ai), never /bookings.\n' +
    '- To connect WhatsApp, Messenger, Instagram or Telegram, link [Channels](/channels), never /settings/channels.\n' +
