...
describe('guardrails · applyOutputGuardrails (integration)', () => {
  ...
  it('ENFORCE: blocks a fake booking confirmation when no booking was recorded', async () => {
    ...
    const r = await applyOutputGuardrails({
      ...
      validationContext: { bookingRecorded: false, requestRecorded: false, bookingRequestRecorded: false, priceContextLoaded: false },
    });
  ...
  it('allows a booking confirmation after a booking was recorded', async () => {
    ...
    const r = await applyOutputGuardrails({
      ...
      validationContext: { bookingRecorded: true, requestRecorded: false, bookingRequestRecorded: false, priceContextLoaded: false },
    });
